...
const PosUserStatus = () => {
  ...
  const handleCancelFileUpload1 = () => {
    setFormData1({ ...formData1, file: null });
                ...
                <Paper sx={{ padding: 4, borderRadius: 2, boxShadow: 3, border: '2px solid #113f6c' }}>
                  ...
                  {isEditMode ? (
                    <form onSubmit={handleSubmit}>
                      ...
                      <Box sx={{ display: 'flex', gap: 2, marginBottom: 2 }}>
                        <FormControl fullWidth>
                          <InputLabel id="reviewmonth-label" sx={{ fontSize: '0.9rem', backgroundColor: 'white', px: 0.5 }}>Review Month </InputLabel>
                        ...
                        <TableContainer>
                          <Table>
                            ...
                            <TableBody>
                              ...
                              <TableRow>    
                                <TableCell style={{ borderBottom: '1px solid #ccc', padding: '10px 25px', whiteSpace: 'nowrap'}}>Review Month</TableCell>
                                <TableCell align="center"><strong>{submittedData?.reviewmonth ||''}</strong></TableCell>
                                <TableCell style={{ borderBottom: '1px solid #ccc', padding: '10px 25px', whiteSpace: 'nowrap'}}>Count of POS Users</TableCell>
                ...
                <div>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, marginBottom: 2, marginLeft:22, marginRight: 10 , marginTop:8}}>
                    <FormControl fullWidth sx={{ boxShadow: 3,  borderRadius: '4px' }}>
                      ...
                      <FormControl fullWidth sx={{ boxShadow: 3,  borderRadius: '4px' }}>
                        <InputLabel id="month-label" sx={{ fontSize: '1rem', backgroundColor: 'white', px: 0.5 }}> Month </InputLabel>
                        <Select
                          labelId="month-label"
                          id="month"
                          value={month}
