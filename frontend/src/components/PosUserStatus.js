                    ...
                    <Box>
                      <Paper sx={{ overflow: 'auto', boxShadow: 3, padding: 2 }}>
                        ...
                        <Box sx={{ mt: 3 }}>
                          ...
                          <Box sx={{ mb: 2, p: 2, borderRadius: 1, border: '1px solid #ccc', backgroundColor: '#f9f9f9' }}>
                            {submittedData1?.fileUrl && submittedData1.fileUrl.length > 0 ? (
                              <ol style={{ paddingLeft: '20px' }}>
                                {submittedData1.fileUrl.map((url, index) => {
                                  // Extract the relevant file name part after the last backslash
                                  const fileName = url.split('\\').pop();  // Split by backslash to get the file name
                                  return (
                                    <li key={index}>
                                      <a
