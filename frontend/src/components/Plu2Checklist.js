...
const Plu2Checklist = () => {
  ...
  const [tabValue, setTabValue] = useState(0); // to control active tab
  ...
  if ((formData.eodStatus === "Failure" || formData.idocFileStatus === "Failure" || 
    formData.plu2Status === "Not Generated" || formData.plu2Status === "Manually Generated" || 
    formData.folderStatus === "F:\\TPDotnet\\Server\\HostData\\Upload\\Invalid" ||
    formData.folderStatus === "F:\\TPDotnet\\Server\\HostData\\Upload\\Data" ) && 
    !formData.remarks) {
  ...
  const handleDownloadPDF = () => {
    ...
    axios
      ...
      .then((response) => {
        ...
        doc.save(`PLU2_checklist_${startDate}_to_${endDate}.pdf`);
      })
      .catch((error) => {
  ...
  const handleDownloadCSV = () => {
    ...
    axios
      ...
      .then((response) => {
        ...
        link.setAttribute('download', `PLU2_checklist_${startDate}_to_${endDate}.csv`);
