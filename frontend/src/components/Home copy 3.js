        ...
        <div className="p-6 min-h-screen bg-gray-100">
          ...
          >
            {["pos", "pdt", "server", "acronics"].map((category) => {
              // Filter out store 9820 only for pos and pdt
              const chartData =
                category === "pos" || category === "pdt"|| category === "acronics"
          ...
          <div className="p-6 min-h-screen bg-gray-100" style={{ paddingLeft: "1285px", height: "0px", width:"0px" }}>
            <div className="grid sm:grid-cols-1 lg:grid-cols-2 gap-6">
              {tables1.map(({ title, color, keyPrefix }) => {
                const excludeStores = ["sale", "pdt", "sale_status", "pos_performance", "acronics_backup"];
                const tableData = excludeStores.includes(keyPrefix)
