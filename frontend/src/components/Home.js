...
const Home = () => {
  ...
  const tables = [
    ...
    { title: "🖥️ POS Status", color: "red", keyPrefix: "pos_status" },
    { title: "⚖️ Scale Status", color: "yellow", keyPrefix: "scale_status" },
    { title: "🖥️ Server Status", color: "gray", keyPrefix: "server_status" },
    { title: "📂 Server Storage", color: "gray", keyPrefix: "server_storage_status" },
    { title: "📄 Zvchr Status", color: "pink", keyPrefix: "zvchr_status" },
  ];

  const tables1 = [
    { title: "💰 Sale Posting", color: "green", keyPrefix: "sale" },
    { title: "🖥️ POS Performance", color: "cyan", keyPrefix: "pos_performance_status" },
    { title: "📱 PDT Status", color: "purple", keyPrefix: "pdt_status" },
    { title: "⚡ UPS Status", color: "orange", keyPrefix: "ups_status" },
    { title: "🛍️ Sale Status", color: "indigo", keyPrefix: "sale_status" },
    { title: "🗂️ Ind Store Backup", color: "amber", keyPrefix: "ind_store_backup_status" },
    { title: "💾 Acronics Backup", color: "lime", keyPrefix: "acronics_backup_status" },
  ];
  ...
  const handleRowClick = (keyPrefix, store, status) => {
    const useYesterday = keyPrefix === "plu2" || keyPrefix === "sale_status" || keyPrefix === "sale" || keyPrefix === "zvchr_status" || keyPrefix === "pos_performance_status";
    ...
    const pathMap = {
      ...
      server_storage_status: "/server_storage_status",
      zvchr_status: "/zvchr_status",
      sale: "/sale_posting",
      pos_performance_status: "/pos_performance_checklist",
      pdt_status: "/pdt_status",
      ups_status: "/ups_amc_status",
      sale_status: "/sales_status",
      ind_store_backup_status: "/ind_store_backup_status",
      acronics_backup_status: "/acronics_backup_status"
    };
        ...
        <div className="p-6 min-h-screen bg-gray-100">
          ...
          <div className="p-6 min-h-screen bg-gray-100" style={{ paddingLeft: "910px", height: "0px", width: "0px" }}>
            <div className="grid sm:grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              else if (keyPrefix === "zvchr_status") {
                tableData = filteredTableData.filter(
                  (store) => store.store !== "9820"
                );
              }
          ...
          <div className="p-6 min-h-screen bg-gray-100" style={{ paddingLeft: "1285px", height: "0px", width:"0px" }}>
            <div className="grid sm:grid-cols-1 lg:grid-cols-2 gap-6">
              {tables1.map(({ title, color, keyPrefix }) => {
                ...
                if (["sale", "pdt_status", "sale_status", "pos_performance_status", "acronics_backup_status"].includes(keyPrefix)) {
                  tableData = tableData.filter(store => store.store !== "9820");
                }

                if (keyPrefix === "pdt_status") {
      ...
      <>
        <div className="p-6 min-h-screen bg-gray-100">
          ...
          <div className="p-6 min-h-screen bg-gray-100" style={{ paddingLeft: "1285px", height: "0px", width:"0px" }}>
            <div className="grid sm:grid-cols-1 lg:grid-cols-2 gap-6">
              {tables1.map(({ title, color, keyPrefix }) => {
                const excludeStores = ["sale", "pdt_status", "sale_status", "pos_performance_status"];
